...
void matmult_fast(int n, int Xpitch, const double X[], int Ypitch,
  ...
  B = X + new_n;
  C = X + new_n * Xpitch;
  D = X + new_n * Xpitch + new_n;
  E = Y;
  F = Y + new_n;
  G = Y + new_n * Ypitch;
  H = Y + new_n * Ypitch + new_n;
  ...
  *P = *P + sz;
  ...
  matmult_fast(new_n, Xpitch / 2, U, Ypitch / 2, T, Xpitch / 2, P,
               min_mat_recurse);
  *P = *P + sz;
  matsub(new_n, Xpitch, B, Xpitch, D, Xpitch / 2, T);
  matadd(new_n, Ypitch, G, Ypitch, H, Xpitch / 2, U);
  matmult_fast(new_n, Xpitch / 2, T, Ypitch / 2, U, Xpitch / 2, P,
               min_mat_recurse);
  *P = *P + sz;
  ...
  matmult_fast(new_n, Xpitch / 2, T, Ypitch / 2, U, Xpitch / 2, P,
               min_mat_recurse);
  matadd(new_n, Xpitch / 2, *P - sz * 3, Xpitch / 2, *P - sz * 2, Xpitch / 2,
         U);
  matsub(new_n, Xpitch / 2, *P - sz, Xpitch / 2, *P - 5 * sz, Xpitch / 2, T);
  matadd(new_n, Xpitch / 2, U, Xpitch / 2, T, Xpitch, Z);
  matadd(new_n, Xpitch / 2, *P - 4 * sz, Xpitch / 2, *P - 3 * sz, Xpitch,
         Z + new_n * Xpitch);
  matadd(new_n, Xpitch / 2, *P - 6 * sz, Xpitch / 2, *P - 5 * sz, Xpitch,
         Z + new_n);
  matadd(new_n, Xpitch / 2, *P - 6 * sz, Xpitch / 2, *P - 2 * sz, Xpitch / 2,
         U);
  matadd(new_n, Xpitch / 2, *P - 4 * sz, Xpitch / 2, P, Xpitch / 2, T);
  matsub(new_n, Xpitch / 2, U, Xpitch / 2, T, Xpitch,
         Z + new_n * Xpitch + new_n);
  free(U);
  free(T);
  for (int i = 0; i < 7; i++) {
    free(P + i);
