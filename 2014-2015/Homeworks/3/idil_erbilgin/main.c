...
int main(int argc, char *argv[])
{
	 ...
	 * 0. eleman programın adı 1.invert 2den itibaren dosya, 2den başlayarak*/
	for (i = 2; i < argc; ++i) {
		 ...
		 * resme efekt uygula ve yeni dosyaya kaydet. */
			 ...
			 * dosyanin adini tutacaktir. sprintf ekrana değil de stringin içine yazdır*/
			 ...
			 * ekrana yazdirin. */
			if (pgm_write(new_filename, pgm_info) > 0) {
